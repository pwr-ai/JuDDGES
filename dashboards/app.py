...
search_judgements_page = st.Page(
    "search_judgements.py", title="Search Judgements", icon="🔍"
)
...
linie_orzecznicze_page = st.Page(
    "linie_orzecznicze.py", title="Linie Orzecznicze", icon="📊"
)
