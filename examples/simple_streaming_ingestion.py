...
def main():
    ...
    try:
        ...
        stats = ingester.process_dataset(dataset_path="JuDDGES/pl-court-raw", streaming=True)
    ...
    try:
        ...
        stats = resume_ingester.process_dataset(dataset_path="JuDDGES/pl-court-raw", streaming=True)
