...
def format_for_typescript_client(ingester: StreamingIngester) -> Dict[str, Any]:
    ...
    return {
        ...
        "metadata": {
            ...
            "generatedAt": response.date_range.generated_at.isoformat()
...
def create_chart_data_format(ingester: StreamingIngester) -> Dict[str, Any]:
    ...
    return {
        "pieCharts": {"documentTypes": doc_types_chart},
        "barCharts": {"countries": countries_chart},
        "lineCharts": {"documentsByYear": year_data},
    }
