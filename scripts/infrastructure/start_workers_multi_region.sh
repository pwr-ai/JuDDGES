...
echo ""
echo "Queue extraction jobs (with automatic filtering of already-processed documents):"
echo "  python scripts/extraction/coordinator.py \\"
echo "    --search-queries 'your search query' \\"
echo "    --max-documents 100000 \\"
echo "    --filter-already-extracted \\"
echo "    --redis-url \"\$REDIS_URL\""
echo ""
echo "Queue ALL documents (no search filter, uses cursor pagination):"
echo "  python scripts/extraction/coordinator.py \\"
echo "    --force-cursor \\"
echo "    --max-documents 1000000 \\"
echo "    --filter-already-extracted \\"
echo "    --redis-url \"\$REDIS_URL\""
echo ""
