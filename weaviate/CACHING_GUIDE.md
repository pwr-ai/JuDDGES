...
export WEAVIATE_API_KEY=PQA2.12-**lafqf
./cache_aggregates.py
```
...
*/30 * * * * cd /home/laugustyniak/github/legal-ai/JuDDGES/weaviate && export WEAVIATE_API_KEY=PQA2.12-**lafqf && ./cache_aggregates.py >> /tmp/cache_aggregates.log 2>&1
```
