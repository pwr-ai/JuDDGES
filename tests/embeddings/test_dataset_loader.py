...
class TestDatasetLoader:
    ...
    def test_load_chunk_dataset_success(self, mock_load_dataset, embedding_config_with_files):
        ...
        mock_load_dataset.assert_called_once_with(
            "parquet",
            data_dir=str(embedding_config_with_files.output_dir / embedding_config_with_files.CHUNK_EMBEDDINGS_DIR),
            split="train",
            num_proc=embedding_config_with_files.num_output_shards
        )

    @patch('scripts.embed.ingest_to_weaviate.load_dataset')
    def test_load_document_embeddings_dataset_success(self, mock_load_dataset, embedding_config_with_files):
        ...
        mock_load_dataset.assert_called_once_with(
            "parquet",
            data_dir=str(embedding_config_with_files.output_dir / embedding_config_with_files.AGG_EMBEDDINGS_DIR),
            split="train",
            num_proc=embedding_config_with_files.num_output_shards
        )
    ...
    def test_path_construction(self, embedding_config_with_files):
        ...
        expected_chunk_path = embedding_config_with_files.output_dir / embedding_config_with_files.CHUNK_EMBEDDINGS_DIR
        expected_agg_path = embedding_config_with_files.output_dir / embedding_config_with_files.AGG_EMBEDDINGS_DIR
