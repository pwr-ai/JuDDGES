...
**Exposed Key**: `AIzaSyDomtCP_KKA1G2z9BL8cl70uBTbZ9t-0K4`
...
GEMINI_API_KEY=AIzaSyDomtCP_KKA1G2z9BL8cl70uBTbZ9t-0K4==>GEMINI_API_KEY=[REDACTED]
GOOGLE_API_KEY=AIzaSyDomtCP_KKA1G2z9BL8cl70uBTbZ9t-0K4==>GOOGLE_API_KEY=[REDACTED]
AIzaSyDomtCP_KKA1G2z9BL8cl70uBTbZ9t-0K4==>[REDACTED-API-KEY]
EOF
...
git log -S "AIzaSyDomtCP_KKA1G2z9BL8cl70uBTbZ9t-0K4" --all
...
echo "AIzaSyDomtCP_KKA1G2z9BL8cl70uBTbZ9t-0K4" > /tmp/passwords.txt
...
git log -S "AIzaSyDomtCP_KKA1G2z9BL8cl70uBTbZ9t-0K4" --all --oneline
...
sed -i 's/AIzaSyDomtCP_KKA1G2z9BL8cl70uBTbZ9t-0K4/[REDACTED-API-KEY]/g' docs/EXTRACTION_STATUS.md
...
sed -i 's/GEMINI_API_KEY=AIzaSyDomtCP_KKA1G2z9BL8cl70uBTbZ9t-0K4/GEMINI_API_KEY=[REDACTED]/g' docs/EXTRACTION_STATUS.md
sed -i 's/GOOGLE_API_KEY=AIzaSyDomtCP_KKA1G2z9BL8cl70uBTbZ9t-0K4/GOOGLE_API_KEY=[REDACTED]/g' docs/EXTRACTION_STATUS.md
...
git grep "AIzaSyDomtCP_KKA1G2z9BL8cl70uBTbZ9t-0K4" $(git rev-list --all)
# Should return: (empty)

# Check current working tree
grep -r "AIzaSyDomtCP_KKA1G2z9BL8cl70uBTbZ9t-0K4" .
# Should return: (empty)
```
...
```
Key: AIzaSyDomtCP_KKA1G2z9BL8cl70uBTbZ9t-0K4
